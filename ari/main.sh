...
srun -o original.out --ntasks=1 -N 1 torchrun --nproc_per_node 4 gpt2_train.py --output_dir original --num_train_epochs 2 --config_file medium.json --per_device_train_batch_size 13 --mixed_precision --logging_steps 50 --eval_steps 50 --max_step 1000000 --no_train &
