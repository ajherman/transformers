...
srun -o bug.out --ntasks=1 -N 1 torchrun --nproc_per_node 4 bug.py --output_dir checkpoints --num_train_epochs 2 --config_file medium.json --per_device_train_batch_size 12 --mixed_precision --save_steps 100000 --logging_steps 50 --eval_steps 50 --gradient_accumulation_steps 8 &
